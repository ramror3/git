...
class WinnersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create winner" do
    assert_difference('Winner.count') do
      post winners_url, params: { winner: { w_description: @winner.w_description, w_goal: @winner.w_goal, w_name: @winner.w_name } }
    end
  ...
  test "should update winner" do
    patch winner_url(@winner), params: { winner: { w_description: @winner.w_description, w_goal: @winner.w_goal, w_name: @winner.w_name } }
