...
class HostelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hostel" do
    assert_difference('Hostel.count') do
      post hostels_url, params: { hostel: { h_address: @hostel.h_address, h_name: @hostel.h_name } }
    end
  ...
  test "should update hostel" do
    patch hostel_url(@hostel), params: { hostel: { h_address: @hostel.h_address, h_name: @hostel.h_name } }
